...
//
#ifndef LINKEDLIST_SINGLELIST_WITHHEAD_H
#define LINKEDLIST_SINGLELIST_WITHHEAD_H
...
class singleList_withHead
{

public:
    singleList_withHead(void);
    ~singleList_withHead(void);
...
#endif //LINKEDLIST_SINGLELIST_WITHHEAD_H
